...
$sectionBlueprint = [
    [
        'header' => 'الجداول',
        'title' => 'التسكين والجداول',
        'icon' => 'fas fa-calendar-alt',
        'items' => array_filter([
            in_array($schedulingViewMode, ['classic', 'both']) ? ['label' => 'التسكين العادي', 'path' => '/scheduling', 'icon' => 'far fa-calendar-check', 'permission' => 'scheduling'] : null,
            ...
            ['label' => 'ترتيب الأولوية', 'path' => '/priority', 'icon' => 'fas fa-sort-amount-up', 'permission' => 'priority'],
            ['label' => 'عرض الجدول', 'path' => '/timetable', 'icon' => 'far fa-clock', 'permission' => 'timetable'],
            ['label' => 'التقارير', 'path' => '/reports', 'icon' => 'fas fa-chart-bar', 'permission' => null],
        ]),
    ],
    [
        'header' => 'البيانات',
        ...
        'items' => [
            ['label' => 'أعضاء هيئة التدريس', 'path' => '/members', 'icon' => 'fas fa-user-tie', 'permission' => 'members'],
            ['label' => 'المقررات الدراسية', 'path' => '/subjects', 'icon' => 'fas fa-book', 'permission' => 'subjects'],
            ['label' => 'تكليفات التدريس', 'path' => '/member-courses', 'icon' => 'fas fa-tasks', 'permission' => 'member_courses'],
            ['label' => 'الأقسام', 'path' => '/departments', 'icon' => 'fas fa-building', 'permission' => 'departments'],
            ['label' => 'الفرق الدراسية', 'path' => '/levels', 'icon' => 'fas fa-layer-group', 'permission' => 'levels'],
            ['label' => 'الشعب', 'path' => '/divisions', 'icon' => 'fas fa-object-group', 'permission' => 'divisions'],
            ['label' => 'السكاشن', 'path' => '/sections', 'icon' => 'fas fa-clone', 'permission' => 'sections'],
            ['label' => 'السنوات والفصول', 'path' => '/academic-years', 'icon' => 'fas fa-calendar', 'permission' => 'academic_years'],
            ['label' => 'القاعات', 'path' => '/classrooms', 'icon' => 'fas fa-door-open', 'permission' => 'classrooms'],
            ['label' => 'الفترات الزمنية', 'path' => '/sessions', 'icon' => 'fas fa-hourglass-half', 'permission' => 'sessions'],
        ],
    ],
    [
        'header' => 'النظام',
        ...
        'icon' => 'fas fa-cog',
        'items' => [
            ['label' => 'الإشعارات', 'path' => '/notifications', 'icon' => 'fas fa-bell', 'permission' => 'notifications'],
            ['label' => 'المستخدمون', 'path' => '/users', 'icon' => 'fas fa-users-cog', 'permission' => 'users'],
            ['label' => 'سجل العمليات', 'path' => '/audit-logs', 'icon' => 'fas fa-history', 'permission' => 'audit'],
            ['label' => 'الإعدادات', 'path' => '/settings', 'icon' => 'fas fa-sliders-h', 'permission' => 'settings'],
            ['label' => 'النسخ الاحتياطي', 'path' => '/backups', 'icon' => 'fas fa-hdd', 'permission' => 'backup'],
        ],
    ],
];
