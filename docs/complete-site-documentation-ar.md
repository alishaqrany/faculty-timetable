...
- إدخال التسكين في [scheduling.php](../scheduling.php) مقيد **بنظام الأولوية (Priority System)** الذي يوفر 4 أوضاع للجدولة (مفتوح، عام، متوازي، تسلسلي).
...
### 5.10 إدارة الأولوية Priority Management

- [priority/index.php](../app/Views/priority/index.php) - الواجهة الرئيسية والتحكم في الأوضاع
- [priority/categories.php](../app/Views/priority/categories.php) - إدارة تصنيفات الأولوية
- [priority/groups.php](../app/Views/priority/groups.php) - إدارة المجموعات وأعضائها
- [priority/exceptions.php](../app/Views/priority/exceptions.php) - الاستثناءات
- [priority/dept-order.php](../app/Views/priority/dept-order.php) - ترتيب الأقسام للتسجيل التسلسلي

### 5.11 عرض الجدول النهائي
...
- لا يمكن التسكين إلا إذا كان العضو مستحقاً لدوره وفقاً لـ **نظام الأولوية** المفعّل (PriorityService).
...
3. إعداد **نظام الأولوية**: إنشاء التصنيفات والمجموعات وترتيب الأقسام.
4. توزيع المواد على الأعضاء.
5. فتح الجدولة من خلال تفعيل **وضع الأولوية** المناسب (عام، أو بالقسم).
6. فتح شاشة التسكين وإدخال السجلات دون تعارض من قبل الأعضاء أصحاب الأولوية.
7. الانتقال إلى الفئة/القسم التالي من قبل المدير في نظام الأولوية عند اكتمال عمل الحاليين.
8. مراجعة الناتج في شاشة عرض الجدول.
